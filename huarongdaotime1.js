onload = function() {
	...
	function change_position(num) {
		...
		var left = "";
		var top="";
		left= nump.style.left;
		top=nump.style.top;
		nump.style.left+= (pic0.style.left-nump.style.left)/1000;
		pic0.style.left += (left-pic0.style.left )/1000;
		nump.style.top+= (pic0.style.top-nump.style.top)/1000;
		pic0.style.top += (top-pic0.style.top )/1000;
	}
